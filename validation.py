...
class Validator:
    ...
    def check_clothes_name(self, clothes_name: str | None) -> bool:  # type: ignore
        ...
        """
        if not clothes_name:
            er_logger.error(f"Incorrect format of clothes_name: {clothes_name}")
            return False
    ...
    def check_clothes_material(self, clothes_material: str | None) -> bool:  # type: ignore
        ...
        if not clothes_material:
            er_logger.error(f"Incorrect format of clothes_material: {clothes_material}")
            return False
    ...
    def check_clothes_description(self, clothes_description: str | None) -> bool:  # type: ignore
        ...
        info_logger.info(f"Clothes description is correct: {clothes_description}")
        return True
